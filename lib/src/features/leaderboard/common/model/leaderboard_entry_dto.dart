...
final class LeaderboardEntryDto {
  const LeaderboardEntryDto({required this.rank, required this.user, this.currentStreakDays, this.totalFocusTimeMs});

  factory LeaderboardEntryDto.fromJson(Map<String, Object?> json) => LeaderboardEntryDto(
  ...
  @override
  int get hashCode => Object.hash(rank, user, currentStreakDays, totalFocusTimeMs);
