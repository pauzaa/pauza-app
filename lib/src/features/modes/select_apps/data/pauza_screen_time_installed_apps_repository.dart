...
abstract interface class InstalledAppsRepository {
  Future<List<AndroidAppInfo>> getAndroidInstalledApps({bool includeSystemApps = false, bool includeIcons = true});
...
class PauzaScreenTimeInstalledAppsRepository implements InstalledAppsRepository {
  ...
  @override
  Future<List<AndroidAppInfo>> getAndroidInstalledApps({bool includeSystemApps = false, bool includeIcons = true}) =>
      _installedAppsManager.getAndroidInstalledApps(includeSystemApps: includeSystemApps, includeIcons: includeIcons);
