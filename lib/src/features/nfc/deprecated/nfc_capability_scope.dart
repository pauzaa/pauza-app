...
//   static NfcCapabilityScope? maybeOf(BuildContext context, {bool listen = true}) {
//     return listen
...
//     return of(context).notifier?.availability ?? NfcChipAvailability.notSupported;
//   }

//   static NfcChipAvailability readAvailability(BuildContext context) {
//     return of(context, listen: false).notifier?.availability ?? NfcChipAvailability.notSupported;
//   }
// }
