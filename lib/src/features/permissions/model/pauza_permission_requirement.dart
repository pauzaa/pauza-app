...
import 'package:pauza_screen_time/pauza_screen_time.dart' show AndroidPermission, IOSPermission, PermissionStatus;

enum PauzaPermissionRequirement {
  androidUsageAccess(id: 'android_usage_access', androidPermission: AndroidPermission.usageStats),
  androidAccessibility(id: 'android_accessibility', androidPermission: AndroidPermission.accessibility),
