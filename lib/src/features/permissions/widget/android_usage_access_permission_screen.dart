...
class AndroidUsageAccessPermissionScreen extends StatelessWidget {
  const AndroidUsageAccessPermissionScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    const requirement = PauzaPermissionRequirement.androidUsageAccess;
