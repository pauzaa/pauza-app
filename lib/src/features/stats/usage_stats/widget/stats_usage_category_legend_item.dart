...
class StatsUsageCategoryLegendItem extends StatelessWidget {
  const StatsUsageCategoryLegendItem({required this.color, required this.label, required this.value, super.key});
