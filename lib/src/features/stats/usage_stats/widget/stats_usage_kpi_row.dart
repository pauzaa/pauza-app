...
class StatsUsageKpiRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Expanded(
          child: StatsKpiCard(label: l10n.totalTime, value: snapshot.totalScreenTime.formatDurationLabel(l10n)),
        ),
        ...
        const SizedBox(width: PauzaSpacing.small),
        Expanded(
          child: StatsKpiCard(label: l10n.statsUsageTableLaunchesColumn, value: snapshot.totalLaunchCount.toString()),
        ),
      ],
    );
  }
