...
void main() {
  group('PauzaUserAvatar', () {
    testWidgets('renders with fallback icon when no imageUrl', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('renders with fallback icon when imageUrl is empty', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('renders with imageUrl', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: PauzaTheme.light,
          home: const Scaffold(
            body: PauzaUserAvatar(imageUrl: 'https://example.com/avatar.jpg'),
          ),
        ),
      );
      ...
      expect(
        avatar.foregroundImage.toString(),
